...
const FreeAds: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      {submitted ? (
        <div className="min-h-[80vh] flex items-center justify-center py-24 px-4 relative overflow-hidden">
           {/* Background Effects */}
           ...
           <div className="relative z-10 max-w-2xl w-full bg-slate-900/90 backdrop-blur-xl rounded-3xl border border-white/10 p-8 md:p-12 shadow-2xl flex flex-col items-center text-center">
              <div className="w-24 h-24 bg-green-500/20 rounded-full flex items-center justify-center mb-6 animate-bounce">
                <CheckCircle className="w-12 h-12 text-green-400" />
              </div>
              <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">Application Received!</h3>
